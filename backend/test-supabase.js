...
async function testSupabase() {
  ...
  const directPool = new Pool({
    connectionString:
      "postgresql://postgres:140293NgocDiem!@db.bdorxcdyegrofvqrogvp.supabase.co:5432/postgres",
  ...
  const poolerPool = new Pool({
    connectionString:
      "postgresql://postgres:140293NgocDiem!@db.bdorxcdyegrofvqrogvp.supabase.co:6543/postgres?pgbouncer=true",
    ssl: { rejectUnauthorized: false },
    connectionTimeoutMillis: 10000,
  });
